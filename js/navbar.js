...
`;
      ...
      <div class="container">
          <div class="row">
              <div class="col-lg-12 contfooter">
                  ...
                  <a class="active" href="https://www.facebook.com/cecleadership/" target="_blank">
                  ...
                  <a class="active" href="https://www.linkedin.com/groups/4276871/" target="_blank">
                  ...
                  <a class="active" href="https://www.instagram.com/muleadershipinstitute/" target="_blank">
  ...
  `;
    ...
    // Dynamically set active tab based on current URL
    ...
    switch (currentPath) {
        case "index.html":
            ...
            break;
        case "cohort.html":
            activeTabId = "cohortTab";
            break;
        case "conference.html":
            activeTabId = "conferenceTab";
            break;
        case "showcases.html":
            activeTabId = "showcasesTab";
            break;
        default:
            activeTabId = "homeTab"; // Default to Home if no match
    }

    // Apply activeTab ID to the matched nav link
    document.getElementById(activeTabId).classList.add("active");
    document.getElementById(activeTabId).id = "activeTab";
});
